...
class Hist_Controller extends Base_Controller {
    ...
    public function post_index() {
        ...
        return View::make($section . '.index')
                        ...
                        ->with('items', Driver::where('city_id','=',$city->city_id)
                        ->left_join('cms_documents', 'drivers.id', '=', 'cms_documents.driver_id')
                        ->order_by('drivers.created_at','DESC')->get(array('drivers.*', 'cms_documents.documento1'))
                        );
