...
Route::post('realtime/service', function() {
            /* $response = "<iframe src = \"http://72.14.178.131:3700/service\" style=\"width:100%;height:800px;\">
...
Route::post('realtime/schedule', function() {
            /* $response = "<iframe src = \"http://72.14.178.131:3700\" style=\"width:100%;height:800px;\">
              <p>Your browser does not support iframes.</p>
              </iframe>"; */
            $response = '<script type="text/javascript">window.open("http://72.14.178.131:3700/schedule/'.Auth::user()->customer_id.'","realTimeSchedules");</script>';
