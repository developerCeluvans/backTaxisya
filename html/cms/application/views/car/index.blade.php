...
<tbody align="center">
    ...
    <tr>
        ...
        <td>
            ...
            <!--<span class="tip" ><img title="ELIMINAR" src="images/icon/icon_delete.png" id="{{$section}}-< ?php echo $item->id; ?>-delete" onclick="document.getElementById('eliminar_conductor').src='../application/views/car/eliminar_conductor.php?var=< ?php echo $item->id; ?>';"></span>-->
