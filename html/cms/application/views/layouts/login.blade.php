    ...
    <body >
        ...
        <div id="login" >
            ...
            <div class="inner clearfix">
                ...
                <div class="formLogin">
                    <form name="formLogin"  id="formLogin" method="post" action="{{action('administrator@login')}}">
                    ...
                    <form id="createaccPage" method="post" action="">
                        ...
                        <div class="loginButton" align="center">
                            ...
                            <button type="button" class="btn btn-danger white " onClick="$('#createaccPage').submit();"><i class="icon-unlock"></i> Register </button>
                        </div>
                    </form> -->
                </div>
            </div>
        ...
        <div class="clear"></div>
        <div id="versionBar" >
            <div class="copyright" > &copy; Copyright 2012  All Rights Reserved <span class="tip"><a  href="#" title="Zice Admin" >Imaginamos</a> </span> </div>
            <!-- // copyright-->
        </div>
        ...
        <script type="text/javascript" >
            $(document).ready(function() {
                @if (Session::has('login_errors'))
                        alertMessage("error", "Ingrese Usuario / Contraseña");
