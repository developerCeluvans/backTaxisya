...
<div class="section" style="display: block;">
		...
		<table style="width:100%">
		  ...
		  <tr>
			...
			<td align="right">
				<a class="btn  btn-large " href="javascript:dataPoster('service-0-search');" id="actualizar_1212" style="font-size:19px;height:22px;width:83%;margin-top:-1%;" tabindex="13">Limpiar</a> 
...
<table class="table" id="dataTable">
    ...
    <tbody align="center">
       ...
       <!-- < ?php  if ($item->status_id == 5 || $item->status_id == '5' ) { ?>
        	<tr bgcolor="#18D224">
        < ? php } else if($item->status_id == 6 || $item->status_id == '6' ||
        				$item->status_id == 7 || $item->status_id == '7' ||
        				$item->status_id == 8 || $item->status_id == '8' ||
        				$item->status_id == 9 || $item->status_id == '9' ){ ? >
		<tr bgcolor="#FF0000"> -->
		
        <?php  if ($item->status_id == 2 || $item->status_id == '2' ) {?>
			<tr bgcolor="yellow">
...
var myVar ;//=setTimeout(function(){myTimer()},30000);
clearTimeout(myVar);
function start(){
	console.log('Start');
	//myVar=setInterval(function(){myTimer()},5000);
	myVar=setTimeout(function(){myTimer()},5000);
