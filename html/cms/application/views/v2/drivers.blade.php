			...
			<div id="content" >
				<div class="inner">
					...
					<div id='mainContainer'>
						...
						{{" Conductores actuales: "}}<strong style="color: red">{{ $total1 }}</strong>
						...
						<div class="tab_container">
							...
							<div id="tab1" class="tab_content">
								...
								<table class="table table-bordered table-striped" id="dataTable">
									...
									<tbody>
										@foreach($waiting_drivers as $driver)
											<tr>
											...
											@if (isset($driver->car->placa))
												<td>{{ $driver->car->placa}}</td>
											@else
												<td></td>
											@endif
