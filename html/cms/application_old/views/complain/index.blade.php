...
<div class="section" style="display: block;">
    <label> Fecha <small> del servicio </small> </label>   
    <div class="section ">
        <div>
            <input readonly="readonly" type="text" name="serv_date" value="{{$headerContent->created_at}}">        </div>
    </div>
    <label> Dirección <small> de usuario </small> </label>   
    <div class="section ">
        <div>
            <input readonly="readonly" type="text" name="user_dir" value="{{$headerContent->index_id . ' ' . $headerContent->comp1 . ' ' . $headerContent->comp2 . ' ' . $headerContent->no}}">        </div>
    </div>
    <label> Barrio <small> de servicio </small> </label>   
    <div class="section ">
        <div>
            <input readonly="readonly" type="email" name="address_neig" value="{{$headerContent->barrio}}">        </div>
    </div>
    <label> Observación <small> de servicio </small> </label>   
    <div class="section ">
        <div>
            <input readonly="readonly" type="email" name="address_obs" value="{{$headerContent->obs}}">        </div>
    </div>
</div>
