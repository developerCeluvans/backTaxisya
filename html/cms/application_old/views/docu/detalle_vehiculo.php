...
<div class="tabla">
  ...
  <?php
    ...
    mysql_select_db('appsuser_taxisya') or die('No se pudo seleccionar la base de datos');
    ...
    while($row=mysql_fetch_row($resu)){
      ...
      echo "
        ...
        <div class='columna'>
          ...
          <div class='celda'>
            <input type='date' id='fech_pago' name='fech_pago' value='$pay_date' $vali_pay_date />
          </div>
