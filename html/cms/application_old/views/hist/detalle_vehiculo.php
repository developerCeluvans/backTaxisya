...
<script>
  function cambiar(proc,id,driver){
    ...
    document.getElementById('proceso').src='http://www.taxisya.co/dev/cms/application/views/docu/proceso.php?'+datos;
    if(proc=='guardar'){
    ...
    $(document).ready(function() {
      $("#detalle_vehiculo").load('http://www.taxisya.co/dev/cms/application/views/docu/detalle_vehiculo.php?id='+driver);
    });
  }
</script>
