    ...
    <div style="display:table-cell;">
      ...
      <script type="text/javascript">
        $(document).ready(function() {
          $("#detalle_vehiculo").load('http://www.taxisya.co/dev/cms/application/views/docu/detalle_vehiculo.php?id=<?php echo $driver_id; ?>');
        });
      </script>
...
<div class="row-fluid">
    ...
    <form action="#" method="POST">
      ...
      <?php if($items[0]->token=='NULL'){?>
        <input type='button' value='Enviar' onclick="if(confirm('Esta seguro de actualizar el estado de la información ?')==true){document.getElementById('calificar').src='http://taxisya.co/dev/cms/application/views/docu/calificar.php?a='+document.getElementById('aprobado').checked+'&r='+document.getElementById('rechazado').checked+'&e='+document.getElementById('eliminado').checked+'&p='+document.getElementById('pendiente').checked+'&i=<?php echo $driver_id; ?>';};">
      <?php }else{ ?>
        <input type='button' value='Enviar' onclick="if(confirm('Esta seguro de actualizar el estado de la información ?')==true){document.getElementById('calificar').src='http://taxisya.co/dev/cms/application/views/docu/calificar.php?a='+document.getElementById('aprobado').checked+'&r='+document.getElementById('rechazado').checked+'&p='+document.getElementById('pendiente').checked+'&i=<?php echo $driver_id; ?>';};">
      <?php } ?>
    </form>
