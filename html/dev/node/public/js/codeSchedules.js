    ...
    if (currentSchedules.get(tmpSchedule.id).get('status') !== tmpSchedule.status) {      
       ...
       if (tmpSchedule.status === "5") {
        ...
        if (timeDiffMilis > 0) {
            ...
            if (timeDiffMilis > 1800000 || (tmpSchedule.status === "5" && (tmpSchedule.service.status_id === "4" || 
