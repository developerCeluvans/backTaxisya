...
<!-- 	        <div class="fileUpload">
 ...
 -->
			...
			<div class="fileUpload">
    			<span>Añadir Imagen Conductor</span>
    			<input type="file" class="photo" name="photo" id="photo" />
			</div>
			<input id="uploadImage" placeholder="Añadir Imagen" disabled="disabled" />

			<div class="fileUpload">
    			<span>Añadir Imagen Documento</span>
    			<input type="file" class="photo" name="document" id="document" />
			</div>
			<input id="uploadImage2" placeholder="Añadir Imagen" disabled="disabled" />

			<div class="fileUpload">
    			<span>Añadir Imagen Documento2</span>
    			<input type="file" class="photo" name="document2" id="document2" />
			</div>
			<input id="uploadImage3" placeholder="Añadir Imagen" disabled="disabled" />

			<div class="fileUpload">
    			<span>Añadir Imagen Documento3</span>
    			<input type="file" class="photo" name="document3" id="document3" />
			</div>
			<input id="uploadImage4" placeholder="Añadir Imagen" disabled="disabled" />
