    ...
    <div class="box-pedirtaxi">
      <form method="get" action="" class="pedir-taxi">
        <fieldset>
          ...
          <div class="clear"></div>
           <p class="reservado">
            <a href="index.php?base&seccion=tu-taxiya">Tu <strong>TAXI YA</strong></a>
          </p>
          <p class="reservado">
            <a href="index.php?base&seccion=servicio-vale">Servicio con Vale</a>
          </p>
          <p class="reservado">
            <a href="index.php?base&seccion=servicio-reservado">Servicio Reservado</a>
          </p>
