...
.caja-img{
	float:right; width:511px; min-height:10px; overflow:hidden; margin:15px 0 0 0;
}
</style>
...
<div id="accordion">
    ...
    <div class="servicios-right">
     ...
     <div class="clear"></div>
          ...
          <h3 id="galeria1">Afiliación Empresas con Vales: <span></span></h3>
          <div class="cont-a"> 
          
    <div class="servicios-right">
       <div class="titulo"> Afiliación Empresas con Vales: </div>
       <div class="texto"><p>Para su empresa ofrecemos el servicio de vales, donde sus empleados pueden pedir el taxi y pagar con vale, el cual será cobrado por TAXIS YA mensualmente a la empresa con que se haya hecho previamente el contrato. Enviar su solicitud de SERVICIO DE VALES como empresa a <strong>vales@taxisya.com.co</strong></p>
    </div>      
     <div class="clear"></div>
    </div> 
      ...
      <div class="titulo">Asesoría de Acompañamiento Jurídico: </div>
       ...
       <div class="texto"><p>TAXIS YA S.A, siempre está a la vanguardia de la tecnología para brindar el mejor servicio de transporte a nuestros afiliados y usuarios, es por este motivo que la empresa tiene a su disposición:</p></div></div>
          ...
          <h3 id="galeria1">Servicio de Radio telefono:  <span></span></h3>
          <div class="cont-a"> 
    ...
    <div class="servicios-right">
      ...
      <div class="titulo">Compra y Venta de vehículos y Cupos( FINANCIACION):   </div>
         <div class="texto"><p>Nuestra empresa se ha destacado  en el mercado del transporte por su seriedad, confiabilidad, responsabilidad y cumplimiento en la gestión de compra y venta de vehículos y de cupos, contando con una gran vitrina la cual tiene el respaldo de las mejores marcas de taxis.</p></div></div>    
          ...
          <h3 id="galeria1">Capacitaciones: <span></span></h3>
          <div class="cont-a"> 
          
         <div class="servicios-right">
      <div class="titulo">Capacitaciones: </div>
...
<ul class="slider">
    <li>
 <img src="imagenes/m1.jpg" style="width:511px; height:328px;" />
   </li>
   <li>
 <img src="imagenes/m2.jpg" style="width:511px; height:328px;" />
   </li>
   <li>
 <img src="imagenes/m3.jpg" style="width:511px; height:328px;" />
   </li>
   <li>
 <img src="imagenes/frecuencia.jpg" style="width:511px; height:328px;" />
   </li>
   <li>
 <img src="imagenes/879.jpg" style="width:511px; height:328px;" />
   </li>
   <li>
 <img src="imagenes/afiliacion.jpg" style="width:511px; height:328px;" />
   </li>
   <li>
 <img src="imagenes/asesoria.jpg" style="width:511px; height:328px;" />
   </li>
</ul>
