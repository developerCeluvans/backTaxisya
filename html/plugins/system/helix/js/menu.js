...
function SubmitAgendarServicio()
{
	cuando = document.getElementById("datepicker2").value;
	hora = document.getElementById("text9").value;
	origen = document.getElementById("text3").value;
	destino = document.getElementById("text4").value;
	telefono = document.getElementById("text10").value;
	
	error = 0;

	if (telefono=="")
		{	error = 1;	document.getElementById("text10").focus(); }
	if (destino=="")
		{	error = 1;	document.getElementById("text4").focus(); }
	if (origen=="")
		{	error = 1;	document.getElementById("text3").focus(); }
	if (hora=="")
		{	error = 1;	document.getElementById("text9").focus(); }
	if (cuando=="")
		{	error = 1;	document.getElementById("datepicker2").focus(); }

	if (error==0)
		document.location.href="http://104.237.131.48/registrarAgenda.php?text10="+telefono+"&text4="+destino+"&text3="+origen+"&text9="+hora+"&datepicker2="+cuando;
}