...
<meta name="author" content="diseÒo web: imaginamos.com" />
...
<script type="text/javascript" src="js/jquery-ui-1.7.custom.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="calendar/jquery.datepick.css"> 
    	
<script type="text/javascript" src="calendar/jquery.datepick.js"></script>
<script type="text/javascript" src="calendar/jquery.datepick-es-PE.js"></script>
        ...
        <div id="pagina-1" class="ui-tabs-panel">
          <form method="get" action="" class="pedir-taxi">
            <fieldset>
              ...
              <div class="clear"></div>
              <p class="reservar">
                <label for="select">Tipo de Servicio</label>
                <select id="tiposerv" name="data[select]" class="cform">
                  <option value="0"></option>
                  <option value="Carrera al aeropuerto">Carrera al aeropuerto</option>
                  <option value="Viaje fuera de la ciudad">Viaje fuera de la ciudad</option>
                  <option value="Servicio en la madrugada">Servicio en la madrugada</option>
                  <option value="Servicio por horas">Servicio por horas</option>
                </select>
              </p>
              <p class="hora-recogida">
                <label for="select">&iquest;A que hora desea que lo recojamos? </label>
                <select id="hora" name="data[select]" class="cform">
                  <option value=""></option>
                ...
                &nbsp;
                <select id="min" name="data[select]" class="cform">
                  <option value=""></option>
                ...
                &nbsp;
                     ...
                     <input id="fecha" type="text" class="calendar" />
...
<a href="index.php?base&seccion=pedir-taxi" class="boton-pedir">Anterior</a>
        ...
        <div id="pagina-2" class="ui-tabs-panel ui-tabs-hide">
          <form name="formuno" method="post" action="" class="pedir-taxi">
            <fieldset>
              <legend>Paso <span class="rojo">3</span> &iquest;D&oacute;nde te recogemos?</legend>
                   <div class="clear"></div>
...
<div class="ejemplo-box">
        ...
        <div id="pagina-3" class="ui-tabs-panel ui-tabs-hide">
          <fieldset>
            <legend>Paso <span class="rojo">4</span></legend>
            <p class="nombre">
...
<p class="num-tel">
            ...
            <p class="nombre">
              ...
              <div id="mensajeerror" class="mensajeerror3">Recuerde que los campos de direcci&oacute;n, barrio, nombre, tel&eacute;fono e email son abligatorios.</div>
    <div id="mensajeerroremail" class="mensajeerroremail3">La direcci&oacute;n de correo electr&oacute;nico es invalida</div>
...
//    var barrio = $('#barrio').val();
    ...
    var horacompleta = 'Fecha: '+fecha+' Hora: '+hora+':'+min;
    var direccioncompleta = 'Direcci&oacute;n: '+dir+' '+dirnum+letra1+' # '+dirnum2+letra2+' - '+dirnum3+letra3+' - '+bti2+' - '+aptofi2;
  if($("#check").is(':checked')){
    ...
    if( dir=='' || dirnum2=='' || dirnum3=='' || nombre == '' || tel == '' || tiposerv == '0' || hora == '' || min == '' || fecha == ''){
        indicador = false;
    }
...
//   }
   ...
   if(tiposerv==''){
       messageError+='No ha indicado Tipo servicio<br />';
   }
    if(email==''){
        indicador=false;
    ...
    if(!indicador){
        ...
        $.post('controllers/servicioreservado.php', { nombre: nombre, email: email, tel: tel, dir: direccioncompleta, serv: servicios, ntaxis: ntaxis, nomenclatura: nomenclatura, hora: horacompleta, tiposerv: tiposerv } , function(datos) {
...
<h1 id="mensajerecibido">"Su servicio est√° en proceso en breve nos comunicaremos con usted"</h1>
